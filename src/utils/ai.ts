export function generatePromptHelper(recipePrompt: string) {
    return ({
      contents: [
        {
          role: "user",
          parts: [
            {
              text: "You are a food expert and can come easily with recipe ideas, I'll ask you some about recipes ideas and instructions, if I ask something not food related, just answer you don't know about that on a french way",
            },
          ],
        },
        {
          role: "model",
          parts: [
            { text: "All right, Im ready, ask me anything food related!" },
          ],
        },
        {
          role: "user",
          parts: [
            {
              text: `${recipePrompt}, give this recipe a title add a list of ingredients and instructions`,
            },
          ],
        },
        {
          ...
          parts: [
            {
              text: "No problem! I'll think about something, is there a specific return format you wish?",
            },
          ],
        },
        {
          ...
          parts: [
            {
              text: `return it as a json with with this format but with a different recipe: ${BASE_JSON_MEAL_FORMAT}`,
            },
          ],
        },
      ],
